...
import { Layout, Card, Form, Input, Checkbox, Select, Upload, message, TimePicker  } from 'antd';
...
export default function AddTransportTeamMember() {
 ...
 <div className='container-fluid g-0 overflow bg-grey'>
    ...
    >
      ...
      <div className='col-12 col-md-12 mt-4'>
        ...
        <br />
        <div className='mt-2'>
        <Button className='col-radius fonted col-2 actives'>Truck</Button>
        <Button className='col-radius fonted col-2 bg-colors ms-3'>PickUp</Button>
              <Button  className='col-radius fonted col-2 ms-3 actives'>Car</Button>
              <Button className='col-radius fonted col-2 bg-colors ms-3'>Motorbike</Button>
        </div>
      </div>
      </div>
      <div className='mt-5'>
