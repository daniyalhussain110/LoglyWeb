                    ...
                    <div className='row justify-content-center'>
                        ...
                        <h1 className='bold'>Welcome,</h1>
                            <p className='f-size'>Let's Get Started</p>
                                ...
                                <Button onClick={() => toggleButton("petLover")} className={(toggleCard === "petLover" ? 'active-list' : 'inActive-list') + ' mt-4 fonts-sizes'} type="primary" block> Pet Lover <span className='text-right'>25463810</span></Button> 
                               
                                <Button onClick={() => toggleButton("businessServiceProvider")} className={(toggleCard === "businessServiceProvider" ? 'active-list' : 'inActive-list') + ' mt-4 fonts-sizes'} type="primary" block>Business Service Provider  <span className='text-right'>25463810 <i className="fas fa-check-circle"></i></span></Button> 
                                ...
                                <Button onClick={Status} className='btn-bg mt-4 fonts-sizes col-8 ms-3' type="primary">CONTINUE  <i className="fas fa-arrow-circle-right ml"></i></Button>
