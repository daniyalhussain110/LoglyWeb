          ...
          <div className='row'>
            ...
            <div className='col-md-6'>
              <div className='mt-3'>
                ...
                <br />
                <TimePicker.RangePicker className='mt-2 upload-image timepicker-range' />
              </div>
            </div>
            ...
            <div className='col-md-4'>
              <div className='mt-3'>
                ...
                <br />
                <TimePicker className='col-12 upload-image timer' defaultOpenValue={moment('00:00:00', 'HH:mm:ss')} />
              </div>
            </div>
  ...
  const ParrotFunc = () => {
    ...
    return(
        ...
        <div className='container-fluid g-0'>
            <div className='row'>
                <div className='col-12 col-md-12'>
                  <Card className='color-maroon' style={{width: 500}}>
                  <div className='d-flex flex-row justify-content-between align-items-center'>
                      <p className='text-white fs-6'>Please Select the animal categories for  <h5 className='text-white mt-3'>Pet Boarding</h5></p>
       ...
       <br />
       <Button id='inActive' onClick={HorseFunc} className={(horse ? 'orangeColor  mt-3 col-4' : 'greyColor mt-3 col-4') + ''} variant="contained" color="primary" style={{textTransform: 'capitalize', fontSize: 12}}>Horse</Button>
         ...
         <div className='container-fluid g-0'>
              <div className='row'>
                  <div className='col-12 col-md-12'>
                        <Card className='color-maroon' style={{width: 500}}>
                        <div className='d-flex flex-row justify-content-between align-items-center'>
                            <p className='text-white fs-6'>Please Select / Add the Services for <h5 className='text-white mt-3'>Pet Boarding</h5></p>
                                <img src={boarding} alt="" className='img-fluid max-fluid'  />
                            </div>
                        </Card>
                        <div className='mt-4'>
                            <Link to="/addboardingforms">
...
function TeamMembers() {
    return(
        ...
        <div className='row'>
          ...
          <div className='mt-5'> 
          <Link to="/addboardingteammember">
              <Button endIcon={<AddIcon />} className='outline left-text col-4' variant="outlined" color="primary"><Typography className='float-left' style={{textTransform: 'capitalize', fontSize: 12}}>Add a Team member</Typography></Button></Link>
          </div>
       </div>
        </div>
      </div>
