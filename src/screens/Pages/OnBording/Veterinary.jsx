...
import { Layout, Card, Calendar, Form, Upload, Input, Radio, TimePicker, message, Checkbox, Avatar, Popover, Modal, Divider } from 'antd'
...
import veterinary from '../../../assets/images/vetinary.png'
  ...
  function AddServices() {
      ...
      return(
          ...
          <div className='container-fluid g-0'>
              <div className='row'>
                  <div className='col-12 col-md-12'>
                    <Card className='color-green-blue' style={{width: 500}}>
                    <div className='d-flex flex-row justify-content-between align-items-center'>
                        <p className='text-white fs-6'>Please Select the animal categories for  <h5 className='text-white mt-3'>Veterinary</h5></p>
                            <img src={veterinary} alt="" className='img-fluid max-fluid'  />
                        </div>
                    </Card>
                    <div className='mt-4'>
